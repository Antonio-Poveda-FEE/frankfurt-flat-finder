    ...
    <div className="space-y-3">
      ...
      {list.length > 0 && (
        <>
          ...
          <p className="text-[11px] text-slate-500">{t('Pulsa la ★ para elegir la foto principal (la que se ve en la lista).', 'Tap the ★ to choose the primary photo (shown in the list).')}</p>
        </>
      )}
    </div>
  )
